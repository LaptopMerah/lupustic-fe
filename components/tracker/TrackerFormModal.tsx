...
export function TrackerFormModal({
  ...
  function handleFile(file: File) {
    if (!file.type.startsWith("image/")) {
      setFieldErrors((prev) => ({
        ...prev,
        image: "Please upload an image file (JPEG, PNG, WebP)",
      }));
      return;
    }
  ...
  function validate(): boolean {
    ...
    if (!name.trim()) errors.name = "Location is required";
        ...
        <div className="space-y-5 py-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g. Left cheek, right forearm..."
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Describe the symptom appearance, sensation, size..."
              rows={4}
              disabled={isSubmitting}
            />
