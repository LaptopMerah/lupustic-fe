...
export function WhyEarlyScreening() {
  const t = useTranslations("whyEarlyScreening")
            ...
            return (
              ...
              >
                <CardContent className="flex flex-col items-center text-center p-8 gap-4">
                  <div className={`flex h-14 w-14 items-center justify-center rounded-2xl ${stat.bgColor} transition-transform group-hover:scale-110 duration-300`}>
